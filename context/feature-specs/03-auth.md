...
Override Clerk appearance variables using the app's existing CSS variables. Do not hardcode variables.
...
Define public routes using the exising sign-in and sign-up env vars. Protect everything else by default.
